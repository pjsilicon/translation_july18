  ...
  const mockTranscription = [
    {
      ...
      startTime: 0,
      endTime: 5.2,
      english: "Hello everyone, I'm Mayor Johnson, and today I want to talk about our new public safety initiatives.",
      translation: "Hola a todos, soy el alcalde Johnson, y hoy quiero hablar sobre nuestras nuevas iniciativas de seguridad pública.",
      confidence: 0.95,
      qaStatus: 'approved',
      audioGenerated: true
    },
    {
      ...
      startTime: 5.3,
      endTime: 10.5,
      english: "Over the past year, we've been working hard to make our city safer for all residents.",
      translation: "Durante el último año, hemos estado trabajando arduamente para hacer nuestra ciudad más segura para todos los residentes.",
      confidence: 0.88,
    ...
    },
    {
      ...
      startTime: 10.6,
      endTime: 15.0,
      english: "Today, I'm proud to announce a comprehensive plan that will address several key areas of concern.",
      translation: "Hoy, me enorgullece anunciar un plan integral que abordará varias áreas clave de preocupación.",
      confidence: 0.92,
      qaStatus: 'pending',
      audioGenerated: false
    }
